...
impl State {
    async fn new(window: &Window) -> Self {
        ...
        // SHADER LOADING
        let vs_module = device.create_shader_module(wgpu::include_spirv!("vert.spv"));
        let fs_module = device.create_shader_module(wgpu::include_spirv!("frag.spv"));
        let flow_cs_module = device.create_shader_module(wgpu::include_spirv!("flow.spv"));
        let flow_vs_module = device.create_shader_module(wgpu::include_spirv!("flowvert.spv"));
        let flow_fs_module = device.create_shader_module(wgpu::include_spirv!("flowfrag.spv"));
